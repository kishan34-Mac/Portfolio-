...
// import { Card, CardContent } from "@/components/ui/card";
// import { Button } from "@/components/ui/button";
// import { ThreeDMarquee, MarqueeImage } from "@/components/ui/marquee";
...
//       title: "Ai-Quiz",
//       description:
//         "An interactive AI-powered quiz designed to test and enhance your knowledge of artificial intelligence concepts and applications.",
//       image: "/lovable-uploads/cd.png",
//       category: "AI/ML",
//       technologies: ["React", "Node.js"],
//       liveUrl: "https://ai-quiz-lyart.vercel.app/",
...
//       image:
//         "/lovable-uploads/EasyDigitalWorkout - Transform Your Home into Your Gym.jpeg",
//       category: "Mobile",
//       technologies: ["React Native", "Firebase", "Redux", "Node.js"],
//       liveUrl: "https://fitness-app.com",
//       githubUrl: "https://github.com/username/fitness-app",
...
//   // Prepare marquee images from project list
//   const marqueeImages: MarqueeImage[] = projects.map((p) => ({
//     src: p.image,
//     alt: p.title,
//     href: p.liveUrl,
//     target: "_blank",
...
//           {/* 🔥 Certificates & Achievements Section (Replaces Marquee) */}
...
//                 </h2>
//                 <p className="text-xl md:text-2xl text-black dark:text-gray-300 pointer-events-none">
...
//                     <div className="relative grid h-full w-full origin-center grid-cols-3 gap-3 transform">
//                       {/* Example Certificate Item */}
//                       <div className="flex flex-col items-center gap-3 relative">
//                         <div className="aspect-[970/700] w-full max-w-[340px] rounded-xl overflow-hidden bg-white shadow-2xl hover:shadow-3xl transition-all duration-300 cursor-pointer">
//                           <img
//                             src="/src/certificates/Certificate.png"
//                             alt="C++ Certificate"
...
//                         <div className="aspect-[970/700] w-full max-w-[340px] rounded-xl overflow-hidden bg-white shadow-2xl hover:shadow-3xl transition-all duration-300 cursor-pointer">
//                           <img
//                             src="/src/certificates/excel.png"
//                             alt="C++ Certificate"
//                             className="w-full h-full object-cover hover:scale-110 transition-transform duration-300"
//                           />
//                         </div>
...
//                       {/* Add more certificate cards here in same structure */}
//                     </div>
//                   </div>
//                 </div>
//               </section>
